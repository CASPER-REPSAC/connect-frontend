  ...
  theme: {
    extend: {
      colors: {
        ...
        secondary: "#03DAC6",
        point: {
          50: withOpacity("--color-connect-point-50"),
          100: withOpacity("--color-connect-point-100"),
          200: withOpacity("--color-connect-point-200"),
          300: withOpacity("--color-connect-point-300"),
          400: withOpacity("--color-connect-point-400"),
          500: withOpacity("--color-connect-point-500"),
          600: withOpacity("--color-connect-point-600"),
          700: withOpacity("--color-connect-point-700"),
          800: withOpacity("--color-connect-point-800"),
          900: withOpacity("--color-connect-point-900"),
        },
        background: {

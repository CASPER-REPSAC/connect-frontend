...
export const CardFrame = (props) => {
  ...
  let prevClassName = `relative transition-all duration-150 ease-in-out bg-background-50 xl:p-4 p-3 hover:shadow-lg hover:bg-background-100 border-2 border-text-400  `;
  if (props.expended) {
